...
const ExpandedHamburger = ({ onClose }) => {
  return (
    <>
      <div className="absolute top-0 w-screen h-screen bg-black z-[998] bg-opacity-60 fadeIn"></div>
      <nav className="absolute top-0 h-screen max-w-96 bg-regularBlue z-[999] slideInFromLeft">
